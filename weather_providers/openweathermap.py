...
def get_icon_from_openweathermap_weathercode(weathercode, is_daytime):
    ...
    icon_dict = { 
            ...
            302 : "climacell_drizzle" if is_daytime else "rain_night",
            310 : "climacell_drizzle" if is_daytime else "rain_night",
            311 : "climacell_drizzle" if is_daytime else "rain_night",
            312 : "climacell_drizzle" if is_daytime else "rain_night",
            313 : "climacell_drizzle" if is_daytime else "rain_night",
            314 : "climacell_drizzle" if is_daytime else "rain_night",
