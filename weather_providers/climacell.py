...
def get_icon_from_climacell_weathercode(weathercode, is_daytime):
    ...
    icon_dict = {
                    ...
                    3001: 'wind',
                    3002: 'wind',
                    4000: 'climacell_drizzle' if is_daytime else 'rain_night_light',
                    4001: 'climacell_rain' if is_daytime else 'rain_night',
                    4200: 'climacell_rain_light' if is_daytime else 'rain_night_light',
                    4201: 'climacell_rain_heavy' if is_daytime else 'rain_night_heavy',
                    5000: 'snow',
