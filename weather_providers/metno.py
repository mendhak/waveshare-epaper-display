...
def get_icon_from_metno_weathercode(weathercode, is_daytime):
    ...
    icon_dict = {
                    ...
                    "fog": "climacell_fog",
                    "heavyrain": "climacell_rain_heavy" if is_daytime else "rain_night",
                    "heavyrainandthunder": "thundershower_rain",
                    "heavyrainshowers": "climacell_rain_heavy" if is_daytime else "rain_night",
                    ...
                    "lightrain": "climacell_rain_light" if is_daytime else "rain_night",
                    "lightrainandthunder": "climacell_rain_light" if is_daytime else "rain_night",
                    "lightrainshowers": "climacell_rain_light" if is_daytime else "rain_night",
                    "lightrainshowersandthunder": "climacell_rain_light" if is_daytime else "rain_night",
                    "lightsleet": "sleet",
...
def get_description_from_metno_weathercode(weathercode):
    description_dict = {
                        "clearsky":	"Clear sky",
                        "cloudy":	"Cloudy",
                        "fair":	"Fair",
...
def get_weather(metno_self_id, location_lat, location_long, units):
    ...
    headers = {"User-Agent": metno_self_id}
    ...
    weather["icon"] = get_icon_from_metno_weathercode(weather_code, daytime)
    weather["description"] = get_description_from_metno_weathercode(weather_code)
