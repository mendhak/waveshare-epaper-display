...
def get_icon_from_openweathermap_weathercode(weathercode, is_daytime):
    ...
    icon_dict = {
                    ...
                    300: "climacell_drizzle" if is_daytime else "rain_night_light",
                    301: "climacell_drizzle" if is_daytime else "rain_night_light",
                    302: "climacell_rain" if is_daytime else "rain_night",
                    310: "climacell_drizzle" if is_daytime else "rain_night_light",
                    311: "climacell_drizzle" if is_daytime else "rain_night_light",
                    312: "climacell_rain" if is_daytime else "rain_night",
                    313: "climacell_rain" if is_daytime else "rain_night",
                    314: "climacell_rain_heavy" if is_daytime else "rain_night_heavy",
                    321: "climacell_drizzle" if is_daytime else "rain_night_light",
                    500: "climacell_rain_light" if is_daytime else "rain_night_light",
                    501: "climacell_rain" if is_daytime else "rain_night",
                    502: "climacell_rain_heavy" if is_daytime else "rain_night_heavy",
                    503: "climacell_rain_heavy" if is_daytime else "rain_night_heavy",
                    504: "climacell_rain_heavy" if is_daytime else "rain_night_heavy",
                    511: "climacell_freezing_rain",
                    520: "climacell_rain_light" if is_daytime else "rain_night_light",
                    521: "climacell_rain" if is_daytime else "rain_night",
                    522: "climacell_rain_heavy" if is_daytime else "rain_night_heavy",
