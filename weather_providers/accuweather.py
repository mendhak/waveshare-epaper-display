...
def get_icon_from_accuweather_weathercode(weathercode, is_daytime):
    ...
    icon_dict = {
                    ...
                    5: "haze",
                    6: "mostly_cloudy" if is_daytime else "mostly_cloudy_night",
                    7: "climacell_cloudy" if is_daytime else 'mostly_cloudy_night',
                    8: "overcast",
                    11: "climacell_fog",
                    12: 'climacell_rain_light' if is_daytime else 'rain_night_light',
                    13: 'climacell_rain_heavy' if is_daytime else 'rain_night_heavy',
                    14: 'climacell_rain_light' if is_daytime else 'rain_night_light',
                    ...
                    37: "haze",
                    38: "mostly_cloudy" if is_daytime else "mostly_cloudy_night",
                    39: 'climacell_rain_light' if is_daytime else 'rain_night_light',
                    40: 'climacell_rain_heavy' if is_daytime else 'rain_night_heavy',
